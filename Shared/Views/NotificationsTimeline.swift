//
//  NotificationsTimeline.swift
//  Essidy App
//
//  Created by Lluís Colomer Coll on 11/5/22.
//

import SwiftUI

struct NotificationsTimeline: View {
...
struct NotificationsTimeline_Previews: PreviewProvider {
